...
STAGES = ["MDS AUG", "MDS JUL", "MDS JUN", "MDS MAY", "MDS APR", "MDS MAR"]
DEFAULT_SETTINGS = {
...
SEED_DATA = {
    "customers": [
        ...
        },
        {
            ...
            "stage": "MDS AUG",
            "expectedClose": "2026-08-04",
            "programPackage": "MCEO Booster Premium",
            "totalAmount": 88000,
            "firstPayment": 30000,
            "firstPaymentDate": "2026-08-04",
            "monthlyInstallment": 14500,
            "totalTerms": 5,
            "paymentDay": 7,
            "nextFollowUp": "2026-08-20",
            "note": "Dummy: 成交并已收 deposit。",
        },
        {
            "id": "c8",
            "name": "Dummy Lee",
            "phone": "012-100 0008",
            "email": "dummy.lee@example.com",
            "source": "MDS AUG 2026",
            "status": "已成交",
            "owner": "Jason",
            "dealValue": 68000,
            ...
            "stage": "MDS AUG",
            "expectedClose": "2026-08-06",
            "programPackage": "MCEO Full Pay",
            "totalAmount": 68000,
            "firstPayment": 68000,
            ...
            "note": "Dummy: full payment。",
        },
        {
            "id": "c9",
            "name": "Dummy Wong",
            "phone": "012-100 0009",
            "email": "dummy.wong@example.com",
            "source": "MDS AUG 2026",
            "status": "考虑中",
            "owner": "Alicia",
            "dealValue": 0,
            ...
            "programPackage": "MCEO Starter",
            "totalAmount": 45000,
            "firstPaymentDate": "2026-08-12",
            "monthlyInstallment": 9000,
            "totalTerms": 5,
            "paymentDay": 12,
            "nextFollowUp": "2026-08-18",
            "note": "Dummy: 需要 follow up partner objection。",
        },
        {
            "id": "c10",
            "name": "Dummy Lim",
            "phone": "012-100 0010",
            "email": "dummy.lim@example.com",
            "source": "MDS AUG 2026",
            "status": "有兴趣",
            "owner": "Mei",
            "dealValue": 0,
            ...
            "programPackage": "MCEO Starter",
            "totalAmount": 38000,
            "monthlyInstallment": 7600,
            "totalTerms": 5,
            "paymentDay": 15,
            "nextFollowUp": "2026-08-19",
            "note": "Dummy: 等待 webinar replay 后决定。",
        },
        {
            "id": "c11",
            "name": "Dummy Goh",
            "phone": "012-100 0011",
            "email": "dummy.goh@example.com",
            "source": "MDS JUL 2026",
            "status": "已成交",
            "owner": "Jason",
            "dealValue": 52000,
            "collectedAmount": 26000,
            "stage": "MDS JUL",
            "expectedClose": "2026-07-27",
            "programPackage": "MCEO Installment",
            "totalAmount": 52000,
            "firstPayment": 26000,
            ...
            "note": "Dummy: 上月成交，本月需要追第二期。",
        },
        {
            "id": "c12",
            "name": "Dummy Ng",
            "phone": "012-100 0012",
            "email": "dummy.ng@example.com",
            "source": "MDS AUG 2026",
            "status": "已成交",
            "owner": "Alicia",
            "dealValue": 72000,
            ...
            "note": "Dummy: 成交，Finance 等 slip。",
        },
        {
            "id": "c13",
            "name": "Dummy Ong",
            "phone": "012-100 0013",
            "email": "dummy.ong@example.com",
            "source": "MDS AUG 2026",
            "status": "暂停",
            "owner": "Mei",
            "dealValue": 0,
            "stage": "MDS AUG",
            "expectedClose": "2026-08-09",
            "programPackage": "MCEO Starter",
            "totalAmount": 36000,
        ...
        },
        {
            ...
            "stage": "MDS AUG",
            "expectedClose": "2026-08-16",
            "programPackage": "MCEO VIP",
            "totalAmount": 96000,
            "firstPayment": 48000,
            "firstPaymentDate": "2026-08-16",
            "monthlyInstallment": 12000,
            "totalTerms": 5,
            "paymentDay": 16,
            "nextFollowUp": "2026-08-24",
            "note": "Dummy: 高票成交，等第二期。",
        },
        {
            "id": "c15",
            "name": "Dummy Chua",
            "phone": "012-100 0015",
            "email": "dummy.chua@example.com",
            "source": "MDS AUG 2026",
            "status": "有兴趣",
            "owner": "Alicia",
            "dealValue": 0,
            "stage": "MDS AUG",
            "expectedClose": "2026-08-19",
            "programPackage": "MCEO Starter",
            "totalAmount": 42000,
    ...
    "activities": [
        ...
        {"id": "a7", "customerId": "c7", "type": "微信", "date": "2026-08-04", "owner": "Mei", "note": "Dummy: 收到 deposit slip，等待第二期。"},
        {"id": "a8", "customerId": "c8", "type": "备注", "date": "2026-08-06", "owner": "Jason", "note": "Dummy: Full payment confirmed。"},
        {"id": "a9", "customerId": "c9", "type": "通话", "date": "2026-08-12", "owner": "Alicia", "note": "Dummy: 需要和 partner 讨论。"},
        {"id": "a10", "customerId": "c10", "type": "微信", "date": "2026-08-15", "owner": "Mei", "note": "Dummy: 已发送案例和课程安排。"},
        {"id": "a11", "customerId": "c11", "type": "会议", "date": "2026-08-10", "owner": "Jason", "note": "Dummy: 第二期收款 follow up。"},
        {"id": "a12", "customerId": "c12", "type": "微信", "date": "2026-08-13", "owner": "Alicia", "note": "Dummy: 等待 finance confirm slip。"},
        {"id": "a13", "customerId": "c13", "type": "备注", "date": "2026-08-09", "owner": "Mei", "note": "Dummy: 暂停，9 月再追。"},
        {"id": "a14", "customerId": "c14", "type": "通话", "date": "2026-08-16", "owner": "Jason", "note": "Dummy: VIP 客户已确认 onboarding。"},
        {"id": "a15", "customerId": "c15", "type": "微信", "date": "2026-08-18", "owner": "Alicia", "note": "Dummy: 今天重点 follow up 付款安排。"},
        {"id": "a16", "customerId": "c16", "type": "会议", "date": "2026-08-17", "owner": "Mei", "note": "Dummy: 成交后安排 onboarding。"},
    ],
    "payments": [
        {"id": "p7", "customerId": "c7", "paymentDate": "2026-08-04", "termNo": 1, "amount": 30000, "method": "Bank Transfer", "slipReceived": "Yes", "remark": "Dummy deposit"},
        {"id": "p8", "customerId": "c8", "paymentDate": "2026-08-06", "termNo": 1, "amount": 68000, "method": "Bank Transfer", "slipReceived": "Yes", "remark": "Dummy full payment"},
        {"id": "p11a", "customerId": "c11", "paymentDate": "2026-07-27", "termNo": 1, "amount": 26000, "method": "Card", "slipReceived": "Yes", "remark": "Dummy first payment"},
        {"id": "p11b", "customerId": "c11", "paymentDate": "2026-08-12", "termNo": 2, "amount": 6500, "method": "Bank Transfer", "slipReceived": "Pending", "remark": "Dummy second term"},
        {"id": "p12", "customerId": "c12", "paymentDate": "2026-08-13", "termNo": 1, "amount": 24000, "method": "Bank Transfer", "slipReceived": "Pending", "remark": "Dummy deposit"},
        {"id": "p14", "customerId": "c14", "paymentDate": "2026-08-16", "termNo": 1, "amount": 48000, "method": "Bank Transfer", "slipReceived": "Yes", "remark": "Dummy VIP deposit"},
        {"id": "p16", "customerId": "c16", "paymentDate": "2026-08-17", "termNo": 1, "amount": 18000, "method": "Bank Transfer", "slipReceived": "Yes", "remark": "Dummy deposit"},
    ],
}
